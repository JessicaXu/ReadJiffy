...
public class MetaData {
    ...
    public static final String AUTHORITY =
        "com.jessicaxu.ReadJiffy.app.data.bookcp";
    ...
    public static final int QUERY_AND_INSERT = 4;
    public static final int QUERY_AND_UPDATE = 5;
    ...
    public static final int STATISTICINFO_LOADER = 1;
